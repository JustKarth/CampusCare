    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main id="main-content" className="flex-1 p-6 md:p-10 fade-in" tabIndex={-1}>
        <div className="max-w-6xl mx-auto">
          <h3 className="text-xl md:text-2xl mb-5 text-text-primary font-semibold">Dashboard Overview</h3>
            ...
            {loading ? (
              ...
              <div className="mt-6 space-y-3 border-t pt-4">
                <p className="text-sm md:text-base">
                  ...
                  <span className="text-text-secondary">{[user.firstName, user.middleName, user.lastName].filter(Boolean).join(' ') || 'N/A'}</span>
                </p>
                <p className="text-sm md:text-base">
                ...
                <p className="text-sm md:text-base">
                  ...
                  <span className="text-text-secondary">{user.collegeName || 'N/A'}</span>
                </p>
                <p className="text-sm md:text-base">
                  <strong className="text-text-primary">Course:</strong>{' '}
                  <span className="text-text-secondary">{user.courseName || 'N/A'}</span>
                </p>
                <p className="text-sm md:text-base">
